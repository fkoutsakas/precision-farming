...
- Ανακοίνωση στο 16ο Μαθητικό Συνέδριο Πληροφορικής Κεντρικής Μακεδονίας με τίτλο "Precision Farming: Η Τεχνητή Νοημοσύνη στην Υπηρεσία του Αγροτικού τομέα
  ...
  - οι φωτογραφίες της εκδήλωσης [ΕΔΩ](https://photos.app.goo.gl/5ZrCVbTDvHbX3q3W7) | Αποθετήριο ανάρτησης όλων των δεδομένων του προγράμματος στην πλατφόρμα GitHub (https://github.com/fkoutsakas/precision-farming)
